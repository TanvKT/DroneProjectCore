...
void locks_test()
{
    ...
    printf("MYRTOS_PRIORITY_LEVELS != 7\r\n");
    printf("Locks Test is deterministic so it needs these values to be set correctly, skipping\r\n");
    #else
    ...
    TEST_ASSERT_EQUAL_MESSAGE(1, mutex1.taken, "Mutex1 should be taken after take");
    TEST_ASSERT_EQUAL_MESSAGE(t1, mutex1.t, "Mutex1 should be held by t1");

    ret = myrtos_mutex_take(&mutex2);
    TEST_ASSERT_EQUAL_MESSAGE(MYRTOS_SUCCESS, ret, "Mutex take failed");
    TEST_ASSERT_EQUAL_MESSAGE(1, mutex2.taken, "Mutex2 should be taken after take");
    ...
    TEST_ASSERT_EQUAL_MESSAGE(0, mutex1.taken, "Mutex1 should be free after give");
    TEST_ASSERT_EQUAL_MESSAGE(NULL, mutex1.t, "Mutex1 holder should be NULL after give");

    ret = myrtos_mutex_give(&mutex2);
    TEST_ASSERT_EQUAL_MESSAGE(MYRTOS_SUCCESS, ret, "Mutex give failed");
    TEST_ASSERT_EQUAL_MESSAGE(0, mutex2.taken, "Mutex2 should be free after give");
    ...
    TEST_ASSERT_EQUAL_MESSAGE(1, mutex1.taken, "Mutex1 should be taken");
    ...
    TEST_ASSERT_EQUAL_MESSAGE(0, mutex1.taken, "Mutex1 should be free");
    ...
    TEST_ASSERT_EQUAL_MESSAGE(0, mutex_zero.n, "Mutex zero should have n=0");
